...
function check4(){
  ...
  function calc(op){
    ...
    if(number1.value.length === 0 || number2.value.length){
 ...
 /*  function check6(){
  ...
  switch(Number(input6.value)){
    case3 : result = "봄"; break;
    case4 : result = "봄"; break;
    case5 : result = "봄"; break;
    
    case6 : result = "여름"; break;
    case7 : result = "여름"; break;
    case8 : result = "여름"; break;
    
    case9 : result = "가을"; break;
    case10 : result = "가을"; break;
    case11 : result = "가을"; break;

    case12 : result = "겨울"; break;
    case1 : result = "겨울"; break;
    case2 : result = "겨울"; break;
