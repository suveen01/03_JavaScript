...
const container = document.querySelector(".container") //감싸는 요소  // css선택자가 일치하는 요소를 하나 선택(쿼리셀렉터)
...
addBtn.addEventListener("click" , ()=>{
  ...
  span.addEventListener("click", e =>{
    ...
    e.target.parentElement.remove(); //한 줄(.row) 제거  //부모요소(parentElement) 제거
  });




  //div, input, span 을 알맞게 조립
