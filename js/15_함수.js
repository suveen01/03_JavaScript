...
btn1.addEventListener("click", function(){
  ...
  // #input1 인 요소에 작성된 값을 얻어와 number 타입으로 변화
...
/* 화살표 함수 */
const arrows = document.querySelectorAll(".arrow"); //버튼4개
...
arrows[2].addEventListener("click", ()=>{
  ...
  const doubleFn = num => num*2;   // = const doubleFn = (num) => { return num*2 } 
...
arrows[3].addEventListener("click", ()=>{
  ...
  const fn1 = () => [1,2,3]; ; // = const fn1 = () => { return [1,2,3]; };
