...
/* 무한 반복 멈추기2 */
function check3(){
  //prompt에 취소가 입력 될 때 까지 숫자를 입력 받아 합계 구하기
  let sum = 0;
...
function startGame(){
  ...
  //Math.floor(실수) -> 소수점 내림 처림(정수로 변환)
  //Math.random() -> 0.0~1.0 사이 난수 발생(1.0미만)
  //맞춰야되는 정답(1~200사이 난수) 생성
